...
def get_DQN_WM_BASE_agent(env, args, writer=None):
    ...
    embed_pos, _ = embed_pos_hd([extractor_feature_policy.convh, extractor_feature_policy.convw], len_embed_pos=args.len_embed_pos)
