...
from utils import *
from runtime import generate_comments
process = psutil.Process(os.getpid())

parser = argparse.ArgumentParser(description='')
# arguments for experiment setting
parser.add_argument('--method', type=str, default='DQN_NOSET', help='DQN_CP, DQN_WM, DQN_NOSET')
parser.add_argument('--game', type=str, default='MiniGrid-DistShift1-v0', help='')
...
parser.add_argument('--comments', type=str, default='_static', help='add something here as an identifier')
# NOSET specific
